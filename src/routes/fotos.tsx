  ...
  return (
    <section className="px-6 max-w-6xl mx-auto pb-4">
      <div className="border-t border-black/10 pt-12">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
          <div>
            <h2 className="font-display text-3xl md:text-4xl">Dronefoto's</h2>
            <p className="text-muted-foreground text-xs uppercase tracking-[0.18em] mt-2">
              Beide woningen vanuit de lucht · Tongeren-Borgloon
            </p>
          </div>
          <p className="text-muted-foreground text-xs">{dronePhotos.length} foto's</p>
        </div>
